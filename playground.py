...
def calculate_coefs(word_dict):
    ...
    for key, value in word_dict.items():
        ...
        if value[key] > 0:  # Sprawdź, czy liczba wystąpień danego słowa z samym sobą jest większa od zera
            word_coefs[key] = degree_val / value[key]
        else:
            word_coefs[key] = 0  # Przypisz 0, jeśli dzielenie przez zero miałoby miejsce
    return word_coefs
