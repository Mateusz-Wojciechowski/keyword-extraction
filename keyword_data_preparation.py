...
keywords_bert = pd.read_csv('keywords/keywords_bert.csv', index_col=None)
keywords_yake = pd.read_csv('keywords/keywords_yake.csv', index_col=None)
keywords_textrank = pd.read_csv('keywords/keywords_textrank.csv', index_col=None)
keywords_rake = pd.read_csv('keywords/keywords_rake.csv', index_col=None)
